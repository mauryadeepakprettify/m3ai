...
const TeamModal = () => {
  ...
  return (
    <div
      ...
      className={`fixed left-1/2 z-50 w-full -translate-x-1/2 overflow-hidden rounded-[10px] bg-[#0C1739] px-8 py-14 transition-all duration-500 ease-in-out md:h-[381px] md:w-[700px] lg:w-[787px] ${
        isModal === "team"
