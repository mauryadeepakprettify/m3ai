...
const Slider = ({
  ...
  return (
    <div className={`relative`}>
      ...
      <div
        className={`absolute z-10 flex items-center justify-between ${paginationType === "fraction" ? "-bottom-3 left-1/2 w-[177px] -translate-x-1/2 rounded-full border border-white p-3" : "top-1/2 right-0 left-0 hidden -translate-y-1/2 md:flex"}`}
      >
        <button
