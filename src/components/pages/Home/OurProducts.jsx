...
const OurProducts = () => {
  return (
    <section className="py-10 sm:py-12 lg:py-16 relative">
        <Gradient className="bg-[#104AF7] left-1/2 top-[40%] blur-[200px]" />
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          <div className="relative">
            <Image
              className="absolute left-0 z-10 bottom-[35px] animate-floatUpDown"
          ...
          <div>
            <div className="relative mb-6 before:absolute before:-bottom-3 before:left-0 before:h-[3px] before:w-[63px] before:bg-[#1B9BD5] before:content-['']">
              <h3 className="relative mb-1 w-fit text-[48px] font-light text-white before:absolute before:top-0 before:-right-10 before:flex before:h-[25px] before:w-[25px] before:items-center before:justify-center before:rounded-full before:border-2 before:border-white before:text-center before:text-[13px] before:content-['R']">
                CREDDT
              </h3>
