  ...
  return (
    <Animate className="relative py-10 sm:py-12 lg:py-20">
      ...
      <div className="container">
        ...
        {
          data?.map(({ id, title, img, tagline, description, features }, index) => (
            <div key={id} className="grid grid-cols-1 gap-14 lg:grid-cols-2 lg:gap-10 not-first:mt-18 md:not-first:mt-32">
              {
                index === 0 ? (<div className="relative h-[400px] md:flex md:h-[450px] md:items-center md:justify-center lg:h-auto">
                  <Image
              ...
              <div className={index % 2 === 0 ? "order-2" : "lg:order-1"}>
                ...
                <Link className="mt-6 block w-full" href={`/product/${id}`}>
...
export const data = [
  {
    id: "creddt",
    title: "CREDDT",
    tagline: "Commercial Real Estate Due Diligence Tools",
    description: "CREDDT is a commercial real estate due diligence and underwriting platform for loan sizing, securitization, and underwriting workflows.Included in its various functionalities, it can automate document extraction, model population, broker package generation, and data tape creation from complex CRE materials.",
    img: "",
    features: [
      {
