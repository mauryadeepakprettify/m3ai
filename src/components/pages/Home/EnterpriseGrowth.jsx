...
const EnterpriseGrowth = () => {
  return (
    <section className="relative py-10 sm:py-12 lg:py-16">
      <Gradient className="top-0 right-4 blur-[200px] bg-[#3853A3]" />
      <Gradient className="top-full left-[20%]  blur-[200px] bg-[#3853A3]" />
      <div className="">
                ...
                <div className="absolute right-0 bottom-0 left-0 z-10 flex items-end justify-between p-[30px]">
                  <div className="">
                    ...
                    <p className="text-alpha max-w-[75%] leading-[22px] font-medium">
                      AI workflows orchestration empowers organizations to
                      automate, coordinate, and optimize complex processes by
                      connecting multiple AI models, tools, and data systems.
                    </p>
                  </div>
